...
public interface DevicePrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    default WorkingState getWorkingState()
    {
        return getWorkingState(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default WorkingState getWorkingState(java.util.Map<String, String> context)
    {
        return _iceI_getWorkingStateAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<WorkingState> getWorkingStateAsync()
    {
        return _iceI_getWorkingStateAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<WorkingState> getWorkingStateAsync(java.util.Map<String, String> context)
    {
        return _iceI_getWorkingStateAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<WorkingState> _iceI_getWorkingStateAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<WorkingState> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getWorkingState", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     WorkingState ret;
                     ret = WorkingState.ice_read(istr);
                     return ret;
                 });
        return f;
    }

    default void toogleWorkingState()
    {
        toogleWorkingState(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void toogleWorkingState(java.util.Map<String, String> context)
    {
        _iceI_toogleWorkingStateAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> toogleWorkingStateAsync()
    {
        return _iceI_toogleWorkingStateAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> toogleWorkingStateAsync(java.util.Map<String, String> context)
    {
        return _iceI_toogleWorkingStateAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_toogleWorkingStateAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "toogleWorkingState", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
        f.invoke(false, context, null, null, null);
        return f;
    }

    default void setWorkingState(WorkingState workingState)
    {
        setWorkingState(workingState, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void setWorkingState(WorkingState workingState, java.util.Map<String, String> context)
    {
        _iceI_setWorkingStateAsync(workingState, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> setWorkingStateAsync(WorkingState workingState)
    {
        return _iceI_setWorkingStateAsync(workingState, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setWorkingStateAsync(WorkingState workingState, java.util.Map<String, String> context)
    {
        return _iceI_setWorkingStateAsync(workingState, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setWorkingStateAsync(WorkingState iceP_workingState, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "setWorkingState", com.zeroc.Ice.OperationMode.Idempotent, sync, null);
